...
namespace TBQuestGame.PresentationLayer
{
    public class GameSessionViewModel : ObservableObject
    {
        ...
        private Location _northLocation, _eastLocation, _southLocation, _westLocation, _northEastLocation;
        ...
        public Location NorthEastLocation
        {
            get { return _northEastLocation; }
            set
            {
                _northEastLocation = value;
                OnPropertyChanged(nameof(NorthEastLocation));
                OnPropertyChanged(nameof(HasNorthEastLocation));
            }
        }
        ...
        public bool HasNorthEastLocation { get { return NorthEastLocation != null; } }
        ...
        private void OnPlayerMove()
        {
            ...
            if (!_player.HasVisited(_currentLocation))
            {
                ...
                _player.Souls += _currentLocation.ModifyExperiencePoints;
            }
        ...
        {
            if (HasNorthEastLocation)
            {
                _gameMap.MoveNorthEast();
                CurrentLocation = _gameMap.CurrentLocation;
                UpdateAvailableTravelPoints();
                OnPlayerMove();
            }
